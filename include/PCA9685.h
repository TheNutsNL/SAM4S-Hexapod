...
namespace Device
{
    ...
    private:
        ...
        System::Driver::TWI* const _twi;
        const uint8_t _address;
        const uint32_t _clockFrequency = 25000000;

        void Write(Register reg, const void *data, uint16_t dataCount) const;
        void Read(Register reg, void *data, uint16_t dataCount) const;
